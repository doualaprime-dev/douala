...
export default function Refrigerateurs() {
    const { refrigerateurs } = usePage().props as any;

    return (
        <div className="container py-4">
            <div className='card shadow-lg p-4 w-full rounded-md bg-white'>
                <h2 className="text-[20px] font-bold text-gray-800 border-b-4 border-[#FFC533] w-full mb-2">Réfrigérateurs</h2>
                    ...
                    <div className="swiper-wrapper items-center">
                        ...
                        >
                            {refrigerateurs.length > 0 ? (
                                refrigerateurs.map((product: any) =>
